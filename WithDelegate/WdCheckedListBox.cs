...
{
	public class WdCheckedListBox : System.Windows.Forms.CheckedListBox
	{
		////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
        delegate void WdSetItemCheckedCallback(int index, bool flg);
        public void WdSetItemChecked(int index, bool flg)
        {
            if (this.InvokeRequired)
            {
                WdSetItemCheckedCallback d = new WdSetItemCheckedCallback(WdSetItemChecked);
                this.Invoke(d, new object[] { index, flg });
            }
            else
            {
                this.SetItemChecked(index, flg);
            }
        }
        ////////////////////////////////////////////////////////////////
        delegate bool WdGetItemCheckedCallback(int index);
        public bool WdGetItemChecked(int index)
        {
            if (this.InvokeRequired)
            {
                WdGetItemCheckedCallback d = new WdGetItemCheckedCallback(WdGetItemChecked);
                return (bool)this.Invoke(d, new object[] { index });
            }
            else
            {
                return this.GetItemChecked(index);
            }
        }
        ////////////////////////////////////////////////////////////////
	}
